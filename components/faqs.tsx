...
export default function FAQComponent() {
  ...
  return (
    <div className="max-w-full mx-auto p-4 text-left display-flex flex-col items-left">
      <h2 className="text-3xl font-bold text-green-700 mb-6 text-left">FAQs</h2>
      <div className="space-y-4">
        {faqs.map((faq, index) => (
          ...
          >
            <button
              className="flex justify-between items-left w-full text-left text-green-800 font-medium text-lg"
